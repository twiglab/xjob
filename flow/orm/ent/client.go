...
import (
	...
	"github.com/twiglab/xjob/flow/orm/ent/migrate"
...
func (c *FlowClient) UpdateOneID(id string) *FlowUpdateOne {
...
func (c *FlowClient) DeleteOneID(id string) *FlowDeleteOne {
...
func (c *FlowClient) Get(ctx context.Context, id string) (*Flow, error) {
	return c.Query().Where(flow.ID(id)).Only(ctx)
}

// GetX is like Get, but panics if an error occurs.
func (c *FlowClient) GetX(ctx context.Context, id string) *Flow {
